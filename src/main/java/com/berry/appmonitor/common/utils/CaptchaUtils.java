 ...
 *
 * @author Berry_Cooper.
 * @date 2018/6/16 22:41
 * fileName：CaptchaUtils
 * Use：验证码工具类
 */
public class CaptchaUtils {
     ...
     * 默认的验证码大小
     */
    private static final int WIDTH = 150, HEIGHT = 40, CODE_SIZE = 4;
    /**
     * 验证码随机字符数组
     */
     ...
     * 生成验证码
     */
    public static void generate(HttpServletResponse response, String vCode) {

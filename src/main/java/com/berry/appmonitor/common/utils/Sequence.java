package com.berry.appmonitor.common.utils;
...
final class Sequence {
    ...
    Sequence(long dataCenterId) {
        this(dataCenterId, getWorkerId(dataCenterId), true, 5L, false);
    }

    Sequence(long dataCenterId, long workerId) {
        this(dataCenterId, workerId, true, 5L, false);
    }
     ...
     */
    private Sequence(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
